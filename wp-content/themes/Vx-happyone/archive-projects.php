...
?>
<section class="wrapper" id="PostCategoryProject">
   <div class="container">
       <div class="row-divide">
           ...
           <div class="col-divide-9 col-divide-md-12 col-divide-sm-12 order-1">
               <h3 class="title--main title--background">Tổng hợp dự án Vạn Xuân</h3>
           <div>
                <?php the_excerpt(); ?>
               </div>
               <div class="row-divide">
