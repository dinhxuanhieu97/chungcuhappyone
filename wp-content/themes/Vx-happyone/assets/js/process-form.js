...
// 		if ("" == o || "" == a) return "" == o && jQuery(".nameVal").css("display", "block"),
// 		jQuery("#mcHTDKTV").click(function () {
// 			jQuery(".nameVal").css("display", "none")
// 		}),
// 		"" !== a ? 0 == p.test(n) ? (jQuery(".phoneVal").empty().append("<span>Số điện thoại không đúng định dạng!</span>"),
//     jQuery(".phoneVal").css("display", "block")) : (jQuery(".phoneVal").empty().append("<span></span>"),
//     jQuery(".phoneVal").css("display", "block")) : (jQuery(".phoneVal").empty().append("Bạn chưa nhập số điện thoại!"),
...
// 					success: function (o) {	"false" == o ? s.css("display", "block") : e.css("display", "block")}
// 				}),
// 				!1
// 			}
// 			return jQuery(".phoneVal").empty().append("<span>Số điện thoại không đúng định dạng!</span>"),
// 			jQuery(".phoneVal").css("display", "block"),
// 			!1
// 		}
// 		var c = jQuery("#happy_one_dang_ki_tu_van_popup").serialize();
