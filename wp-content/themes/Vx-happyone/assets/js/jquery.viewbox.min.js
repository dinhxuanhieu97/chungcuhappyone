...
!(function (i) {
  i.fn.viewbox = function (t) {
    function n() {
      ...
      var n = o("body");
      n.css({ "margin-left": -n.width() / 2, "margin-top": -n.height() / 2 });
    }
    function e() {
      w &&
        (g.fadeOut(t.closeDuration, function () {
          g.detach();
        }),
        (w = !1));
    }
    ...
    function u(t) {
      ...
      return (
        n
          ...
          .insertAdjacentHTML(
            "afterbegin",
            '<svg><use xlink:href="#viewbox-' + t + '-icon"/></svg>'
          ),
        n
      );
    }
    ...
    return (
      ...
      f.click(function () {
        if (!b) {
          if (
            (($e = i(this)),
            a("header", t.setTitle && $e.attr("title") ? $e.attr("title") : ""),
            l($e.attr("href")))
          ) {
            var e = i('<img class="viewbox-image" alt="">').attr(
              "src",
              $e.attr("href")
            );
      ...
      t.closeButton &&
        u("close").click(function (i) {
          i.stopPropagation(), e();
        }),
      t.navButtons &&
        f.length > 1 &&
        (u("next").click(function (i) {
          i.stopPropagation(), r();
        }),
        u("prev").click(function (i) {
          i.stopPropagation(), d();
        })),
      t.closeOnSideClick && g.click(e),
      this
    );
  };
})(jQuery);
