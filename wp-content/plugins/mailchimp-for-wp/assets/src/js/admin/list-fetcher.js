    ...
    [
      m("p", [
        m("input", {
          type: "submit",
          value: state.working
            ? i18n.fetching_mailchimp_lists
            : i18n.renew_mailchimp_lists,
          className: "button",
        ...
        state.working
          ? [m("span.mc4wp-loader", "Loading..."), m.trust(" &nbsp; ")]
          : "",
        state.done
          ? [
              state.success
                ? m("em.mc4wp-green", i18n.fetching_mailchimp_lists_done)
                : m("em.mc4wp-red", i18n.fetching_mailchimp_lists_error),
            ]
          : "",
      ]),
    ]
