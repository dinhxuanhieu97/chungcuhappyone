...
jQuery(document).ready(function ($) {
  ...
  eztoc_deactivate_link = $(
    '.wp-admin.plugins-php tr[data-slug="easy-table-of-contents"] .row-actions .deactivate a'
  );
  ...
  $("#eztoc-reloaded-feedback-content form").submit(function (e) {
    ...
    $.post(
      ajaxurl,
      {
        ...
        data:
          $("#eztoc-reloaded-feedback-content form").serialize() +
          "&eztoc_security_nonce=" +
          cn_toc_admin_data.eztoc_security_nonce,
      },
      function (data) {
        if (data == "sent") {
  ...
  $("#eztoc-reloaded-feedback-content .eztoc-feedback-only-deactivate").click(
    function (e) {
      e.preventDefault();
  ...
  $(".eztoc-feedback-not-deactivate").click(function (e) {
    ...
    var elementText = $('#eztoc-reloaded-feedback-content input[type="radio"]')
      .parents("li")
      .next("li")
      .children('input[type="text"], textarea');
    $(elementText)
  ...
  function eztoc_admin_get_cookie(name) {
    var i,
      x,
      y,
      eztoc_cookies = document.cookie.split(";");
  ...
  function eztoc_set_feedback_cookie() {
    ...
    document.cookie =
      "eztoc_hide_deactivate_feedback=1; expires=" +
      exdate.toUTCString() +
      "; path=/";
  }
}); // document ready
