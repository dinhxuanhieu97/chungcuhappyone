jQuery(document).ready(function ($) {
  ...
  var ezTocSettingsCustomWidth = document.getElementById(
    "ez-toc-settings[width_custom]"
  );
  ...
  $("#reset-options-to-default-button").click(function () {
    ...
    if (confirm(text) == true) {
      $.post(
        ajaxurl,
        {
          action: "eztoc_reset_options_to_default",
...
function ezTocSettingsTabsFixed() {
  var ezTocProSettingsContainer =
    '<span class="general-pro-settings-container"> | <a href="#eztoc-prosettings" id="eztoc-link-prosettings">Pro Settings</a></span>';
  ...
  if (ezTocGeneralTabs !== null) {
    window.onscroll = function () {
      ...
      var ez_toc_pro_settings_link_paid = document.getElementsByClassName(
        "ez-toc-pro-settings-link-paid"
      );
      var ezTocElementProSettingsContainer = document.getElementsByClassName(
        "general-pro-settings-container"
      );

      var ezTocGeneralTabsLinkGeneral = document.querySelector(
        "#general #eztoc-tabs #eztoc-link-general"
      );
      var ezTocGeneralTabsLinkAppearance = document.querySelector(
        "#general #eztoc-tabs #eztoc-link-appearance"
      );
      var ezTocGeneralTabsLinkAdvanced = document.querySelector(
        "#general #eztoc-tabs #eztoc-link-advanced"
      );
      var ezTocGeneralTabsLinkShortcode = document.querySelector(
        "#general #eztoc-tabs #eztoc-link-shortcode"
      );
      var ezTocGeneralTabsLinkProSettings = document.querySelector(
        "#general #eztoc-tabs #eztoc-link-prosettings"
      );

      var minusOffsetTop = 100;

      var ezTocGeneralContainerGeneral =
        document.querySelector("#general div#eztoc-general").offsetTop -
        minusOffsetTop;
      var ezTocGeneralContainerAppearance =
        document.querySelector("#general div#eztoc-appearance").offsetTop -
        minusOffsetTop;
      var ezTocGeneralContainerAdvanced =
        document.querySelector("#general div#eztoc-advanced").offsetTop -
        minusOffsetTop;
      var ezTocGeneralContainerShortcode =
        document.querySelector("#general div#eztoc-shortcode").offsetTop -
        minusOffsetTop;
      if (
        ez_toc_pro_settings_link_paid !== null &&
        ez_toc_pro_settings_link_paid.length > 0
      ) {
        var ezTocGeneralContainerProSettings =
          document.querySelector("#general div#eztoc-prosettings").offsetTop -
          minusOffsetTop -
          150;
      } else {
      ...
      if (
        ezTocElementProSettingsContainer.length > 0 &&
        ezTocGeneralTabsLinkProSettings !== null
      )
      ...
      if (
        ezTocElementProSettingsContainer.length > 0 &&
        y >= ezTocGeneralContainerProSettings
      ) {
