(window.CMB2 = window.CMB2 || {}),
  (function (window, document, $, cmb, undefined) {
    ...
    var defaults = {
      idNumber: !1,
      repeatEls:
        'input:not([type="button"]),select,textarea,.cmb2-media-status',
      noEmpty:
    ...
    (cmb.init = function () {
          ...
          wp.data.subscribe(function () {
            ...
            if (
              ...
              for (var i = 0; i < window.tinyMCE.editors.length; i++)
                window.tinyMCE.activeEditor !== window.tinyMCE.editors[i] &&
      ...
      (cmb.toggleCheckBoxes = function (evt) {
        ...
        $this.data("checked")
          ? ($multicheck.prop("checked", !1), $this.data("checked", !1))
          : ($multicheck.prop("checked", !0), $this.data("checked", !0));
      }),
      ...
      (cmb.handleFileClick = function (evt) {
        if (!$(evt.target).is("a")) {
          ...
          var $el = $(this),
            ...
            isList = $td
              .find(".cmb2-upload-button")
              .hasClass("cmb2-upload-list");
        ...
        if (wp) {
          ...
          (media.frames[id] = wp.media({
            ...
            (handlers.list = function (selection, returnIt) {
              ...
              if (
                ...
                selection.each(function (attachment) {
                  (attachmentHtml = handlers.getAttachmentHtml(
                    attachment,
                    "list"
                  )),
            ...
            (handlers.single = function (selection) {
              ...
              var attachmentHtml = handlers.getAttachmentHtml(
                attachment,
                "single"
              );
              media.$field
            ...
            (handlers.getAttachmentHtml = function (attachment, templatesId) {
              ...
              return handlers[templatesId].templates[
                isImage ? "image" : "file"
              ](data);
            }),
      ...
      (cmb.handleRemoveMedia = function (evt) {
        ...
        return $this.is(".cmb-attach-list .cmb2-remove-file-button")
          ...
          : ((cmb.media.field = $this.attr("rel")),
            cmb
              .metabox()
              .find(document.getElementById(cmb.media.field))
              .val(""),
            cmb
              .metabox()
      ...
      (cmb.elReplacements = function ($newInput, prevNum, group) {
        ...
        if (
          ("TEXTAREA" === tagName && $newInput.html(newVal),
          "SELECT" === tagName && void 0 !== defVal)
        ) {
        ...
        return (
          ...
          !group &&
            $newInput[0].hasAttribute("data-iterator") &&
        ...
        return (
          $colorPicker.length &&
            $colorPicker.each(function () {
              ...
              $td.html(
                $td
                  .find('input[type="text"].cmb2-colorpicker')
                  .attr("style", "")
              );
            }),
      ...
      (cmb.addGroupRow = function (evt) {
        ...
        cmb
          ...
          .cleanRow($row, prevNum, !0),
          $row.find(".cmb-add-row-button").prop("disabled", !1);
        var $newRow = $(
          "<" +
            nodeName +
            ' id="' +
      ...
      (cmb.removeGroupRow = function (evt) {
        ...
        if (
          ...
          if ($table.find(".cmb-repeatable-grouping").length < 2)
            return cmb.resetRow(
              $parent
                .parents(".cmb-repeatable-group")
                .find(".cmb-add-group-row"),
              $this
            );
      ...
      (cmb.resetRow = function ($addNewBtn, $removeBtn) {
        (cmb.resetRow.resetting = !0),
          $addNewBtn.trigger("click"),
          $removeBtn.trigger("click"),
          (cmb.resetRow.resetting = !1);
      }),
      (cmb.shiftRows = function (evt) {
        evt.preventDefault();
        var $this = $(this),
          moveUp = !!$this.hasClass("move-up"),
          $from = $this.parents(".cmb-repeatable-grouping"),
          $goto = $from[moveUp ? "prev" : "next"](".cmb-repeatable-grouping");
        if (
          (cmb.triggerElement(
            $this,
          ...
          var fromIterator = $from.attr("data-iterator"),
            toIterator = $goto.attr("data-iterator");
          $from
      ...
      (cmb.datePickerSetupOpts = function (fieldOpts, options, method) {
        ...
        return (
          (options.beforeShow = function (input, inst) {
            "timepicker" === method && cmb.addTimePickerClasses(inst.dpDiv),
              $id("ui-datepicker-div").addClass("cmb2-element"),
              "function" == typeof existing.beforeShow &&
          ...
          "timepicker" === method &&
            (options.onChangeMonthYear = function (year, month, inst, picker) {
              cmb.addTimePickerClasses(inst.dpDiv),
                "function" == typeof existing.onChangeMonthYear &&
                  existing.onChangeMonthYear(year, month, inst, picker);
            }),
          (options.onClose = function (dateText, inst) {
            var $picker = $id("ui-datepicker-div")
              .removeClass("cmb2-element")
              .hide();
            "timepicker" !== method ||
              $(inst.input).val() ||
              inst.input.val($picker.find(".ui_tpicker_time").text()),
              "function" == typeof existing.onClose &&
        ...
        $selector.length &&
          ...
          "function" == typeof jQuery.wp.wpColorPicker
            ? $selector.each(function () {
                ...
                $this.wpColorPicker(
                  $.extend({}, cmb.defaults.color_picker, fieldOpts)
                );
              })
            : $selector
                .each(function (i) {
      ...
      (cmb.codeEditorArgs = function (overrides) {
        ...
        for (var i = props.length - 1; i >= 0; i--)
          overrides.hasOwnProperty(props[i]) &&
            (args[props[i]] = $.extend(
              {},
              args[props[i]] || {},
              overrides[props[i]]
      ...
      (cmb.makeListSortable = function () {
        var $filelist = cmb
          .metabox()
          .find(".cmb2-media-status.cmb-attach-list");
        $filelist.length &&
      ...
      (cmb.resizeoEmbeds = function () {
        cmb.metabox().each(function () {
          ...
          cmb.styleBreakPoint > tableW &&
            ((isSmall = !0), (isSmallest = cmb.styleBreakPoint - 62 > tableW)),
            (tableW = isSmall
              ? tableW
              : Math.round(0.82 * $tableWrap.width() * 0.97));
          var newWidth = tableW - 30;
          if (
            (!isSmall || isSide || isSmallest || (newWidth -= 75),
            newWidth > 639)
          )
            return !0;
          ...
          $children.each(function () {
            var $this = $(this),
              ...
              iheight = $this.height(),
              _newWidth = newWidth;
            $this.parents(".cmb-repeat-row").length &&
              !isSmall &&
      ...
      (cmb.metabox = function () {
        return cmb.$metabox
          ? cmb.$metabox
          : ((cmb.$metabox = $(".cmb2-wrap > .cmb2-metabox")), cmb.$metabox);
      }),
    ...
    function initOptions(options) {
      ...
      if (void 0 === tinyMCEPreInit.mceInit[options.id]) {
        ...
        for (prop in newSettings)
          "string" == typeof newSettings[prop] &&
      ...
      (wysiwyg.initRow = function ($row, evt) {
        ...
        $row.find(".cmb2-wysiwyg-inner-wrap").each(function () {
          ($toReplace = $(this)),
            ...
            (data.value =
              "cmb2_add_row" !== evt.type &&
              $toReplace.find(".wp-editor-area").length
      ...
      (wysiwyg.destroy = function (id) {
        if (cmb.canTinyMCE()) {
          ...
          null !== editor && void 0 !== editor
            ? (editor.destroy(),
              void 0 === tinyMCEPreInit.mceInit[id] &&
                delete tinyMCEPreInit.mceInit[id],
              void 0 === tinyMCEPreInit.qtInit[id] &&
                delete tinyMCEPreInit.qtInit[id])
            : -1 === toBeDestroyed.indexOf(id) &&
              (toBeDestroyed.push(id), window.setTimeout(delayedDestroy, 100));
        }
      }),
    ...
    (counter.updateCounter = function (field_id) {
      ...
      (counter.cleanCounters = function () {
        ...
        for (field_id in counters)
          document.getElementById(field_id) || remove.push(field_id);
        remove.length &&
      ...
      (counter.countWysiwyg = _.throttle(function (evt) {
        return evt.hasOwnProperty("element")
          ? counter.updateCounter($(evt.element).data("id"))
          : evt.hasOwnProperty("currentTarget")
          ? counter.updateCounter($(evt.currentTarget).data("id"))
          : void 0;
      })),
