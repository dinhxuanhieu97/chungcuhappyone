  ...
  (this.wp.url = (function (e) {
    ...
    427: function (e, t, r) {
      ...
      function b() {
        ...
        return (
          -1 !== n &&
            ((t = Object.assign(Object(m.parse)(e.substr(n + 1)), t)),
            (r = r.substr(0, n))),
          r + "?" + Object(m.stringify)(t)
        );
      }
      function g(e, t) {
        var r = e.indexOf("?");
        return (-1 !== r ? Object(m.parse)(e.substr(r + 1)) : {})[t];
      }
      function v(e, t) {
        return void 0 !== g(e, t);
      }
      function O(e) {
        for (
          var t = e.indexOf("?"),
            r = -1 !== t ? Object(m.parse)(e.substr(t + 1)) : {},
        ...
        return (
          ...
          n + "?" + Object(m.stringify)(r)
        );
      }
      var j = /^(?:[a-z]+:|#|\?|\.|\/)/i;
      function w(e) {
        return e ? ((e = e.trim()), j.test(e) || i(e) ? e : "http://" + e) : e;
      }
      function x(e) {
        try {
          return decodeURI(e);
