...
class CDNMapping extends React.Component {
  ...
  onChange(e, index) {
    ...
    const value = target.dataset.hasOwnProperty("value")
      ? Boolean(target.dataset.value * 1)
      : target.value;
    ...
    return (
      <React.Fragment>
        ...
        <p>
          <button
            type="button"
            className="button button-link litespeed-form-action litespeed-link-with-icon"
            onClick={this.addNew}
          >
      ...
      <div className="litespeed-block">
        <div className="litespeed-cdn-mapping-col1">
          <label className="litespeed-form-label">
            {litespeed_data["lang"]["cdn_mapping_url"]}
          </label>
          <input
            type="text"
          ...
          <div className="litespeed-desc">
            <span
              dangerouslySetInnerHTML={{
                __html: litespeed_data["lang"]["cdn_mapping_url_desc"],
              }}
            />
          </div>
        </div>
        ...
        <div className="litespeed-col-auto litespeed-cdn-mapping-col2">
          <div className="litespeed-row litespeed-toggle-wrapper">
            ...
            <div
              className={`litespeed-toggle litespeed-toggle-btn litespeed-toggle-btn-${
                item.inc_img ? "primary" : "default litespeed-toggleoff"
              }`}
              data-type="inc_img"
            ...
            >
              <input
                name={name_prefix + "[inc_img][]"}
                type="hidden"
                value={item.inc_img ? 1 : 0}
              />
              <div className="litespeed-toggle-group">
                <label className="litespeed-toggle-btn litespeed-toggle-btn-primary litespeed-toggle-on">
                  {litespeed_data["lang"]["on"]}
                </label>
          ...
          <div className="litespeed-row litespeed-toggle-wrapper">
            ...
            <div
              className={`litespeed-toggle litespeed-toggle-btn litespeed-toggle-btn-${
                item.inc_css ? "primary" : "default litespeed-toggleoff"
              }`}
              data-type="inc_css"
            ...
            >
              <input
                name={name_prefix + "[inc_css][]"}
                type="hidden"
                value={item.inc_css ? 1 : 0}
              />
              <div className="litespeed-toggle-group">
                <label className="litespeed-toggle-btn litespeed-toggle-btn-primary litespeed-toggle-on">
                  {litespeed_data["lang"]["on"]}
          ...
          <div className="litespeed-row litespeed-toggle-wrapper">
            ...
            <div
              className={`litespeed-toggle litespeed-toggle-btn litespeed-toggle-btn-${
                item.inc_js ? "primary" : "default litespeed-toggleoff"
              }`}
              data-type="inc_js"
            ...
            >
              <input
                name={name_prefix + "[inc_js][]"}
                type="hidden"
                value={item.inc_js ? 1 : 0}
              />
              <div className="litespeed-toggle-group">
                <label className="litespeed-toggle-btn litespeed-toggle-btn-primary litespeed-toggle-on">
                  {litespeed_data["lang"]["on"]}
        ...
        <div className="litespeed-col-auto">
          <button
            type="button"
            className="button button-link litespeed-collection-button litespeed-danger"
            onClick={this.delRow}
          >
            <span className="dashicons dashicons-dismiss"></span>
            <span className="screen-reader-text">
              {litespeed_data["lang"]["cdn_mapping_remove"]}
            </span>
          </button>
        </div>
      </div>
