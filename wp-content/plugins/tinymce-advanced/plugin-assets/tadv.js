...
jQuery(document).ready(function ($) {
  ...
  $("#menubar").on("change", function () {
    $(".tadv-mce-menu.tadv-classic-editor").toggleClass(
      "enabled",
      $(this).prop("checked")
    );
  });
  ...
  $("#menubar_block").on("change", function () {
    $(".tadv-mce-menu.tadv-block-editor").toggleClass(
      "enabled",
      $(this).prop("checked")
    );
  });
  ...
  $(".tadv-popout-help-toggle, .tadv-popout-help-close").on(
    "click",
    function (event) {
