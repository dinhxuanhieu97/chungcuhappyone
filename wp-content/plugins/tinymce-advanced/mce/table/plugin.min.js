!(function (m) {
          ...
          for (
            ...
            for (var f = !1, s = 0; s < a; s++)
              l < n.minRow() ||
                ...
                s < n.minCol() ||
                s > n.maxCol() ||
                (mn.getAt(t, l, s).filter(r).isNone()
                  ? ((o = f),
                    (i = e[l].element()),
                    (u = xe.fromTag("td")),
                    Rt(u, xe.fromTag("br")),
  ...
  var bo = function (e) {
    ...
    Yu = {
      directionAt: function (e) {
        return "rtl" == ("rtl" === Ne(e, "direction") ? "rtl" : "ltr")
          ? Gu
          : Vu;
      },
    },
  ...
  var Za = function (t, n, e) {
    ...
    Wc = document.caretPositionFromPoint
      ? function (n, e, t) {
          return R.from(n.dom().caretPositionFromPoint(e, t)).bind(function (
            e
          ) {
