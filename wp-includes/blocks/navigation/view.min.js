!(function (e) {
  ...
  kVj6: function (e, t, o) {
    ...
    function g(e) {
      const t = e.target.closest("[aria-expanded]");
      if ("true" === t.getAttribute("aria-expanded"))
        v(t.closest(".wp-block-navigation-item"));
      else {
        const e = t.closest(".wp-block-navigation-item");
        t
          .closest(
    ...
    window.addEventListener("load", () => {
      f.init({ onShow: h, onClose: h, openClass: "is-menu-open" });
      document
        ...
        document.addEventListener("click", function (e) {
          document
            .querySelectorAll(".wp-block-navigation")
            .forEach(function (t) {
              t.contains(e.target) || v(t);
            });
        }),
