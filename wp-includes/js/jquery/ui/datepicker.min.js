      ...
      _generateHTML: function (e) {
        ...
        for (
          e.drawMonth = B,
            ...
            L = this._get(e, "gotoCurrent") && e.currentDay ? U : K,
            A = R ? this.formatDate(A, L, this._getFormatConfig(e)) : A,
            W = "",
            e.inline ||
              (W = V("<button>")
                .attr({
            ...
            R = "",
            O &&
              (R = V("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(j ? W : "")
                .append(
                  this._isInRange(e, L)
                    ? V("<button>")
          ...
          for (k = "", this.maxRows = 4, D = 0; D < H[1]; D++) {
            ...
            for (
              v += M + "</tr></thead><tbody>",
                ...
                C = Math.ceil((w + C) / 7),
                I = E && this.maxRows > C ? this.maxRows : C,
                this.maxRows = I,
                  ...
                  (S +=
                    ...
                    (N && !h
                      ...
                      : "<a class='ui-state-default" +
                        ...
                        "' href='#' aria-current='" +
                        (x.getTime() === U.getTime() ? "true" : "false") +
                        "' data-date='" +
                        x.getDate() +
                        "'>" +
                        x.getDate() +
