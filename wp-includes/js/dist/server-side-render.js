...
this["wp"]["serverSideRender"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ "4dqW": /***/ function (
      ...
      function rendererPath(block) {
        ...
        let urlQueryArgs =
          arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : {};
        return Object(external_wp_url_["addQueryArgs"])(
      ...
      function ServerSideRender(props) {
        ...
        function fetchData() {
          ...
          const sanitizedAttributes =
            attributes &&
            Object(
              external_wp_blocks_["__experimentalSanitizeBlockAttributes"]
            )(block, attributes); // If httpMethod is 'POST', send the attributes in the request body instead of the URL.
      ...
      const EMPTY_OBJECT = {};
      const ExportedServerSideRender = Object(external_wp_data_["withSelect"])(
        (select) => {
      ...
      if (window && window.wp && window.wp.components) {
        window.wp.components.ServerSideRender = Object(
