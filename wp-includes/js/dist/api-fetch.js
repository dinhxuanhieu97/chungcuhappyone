    ...
    /***/ jqrR: /***/ function (
      ...
      function createPreloadingMiddleware(preloadedData) {
        const cache = Object.keys(preloadedData).reduce(
          (result, path) => {
            result[Object(external_wp_url_["normalizePath"])(path)] =
              preloadedData[path];
            return result;
          },
      ...
      const modifyQuery = (_ref, queryArgs) => {
        ...
        return {
          ...
          path:
            path && Object(external_wp_url_["addQueryArgs"])(path, queryArgs),
        };
      };
      /**
      ...
      /* harmony default export */ var fetch_all_middleware =
        fetchAllMiddleware;
      ...
      const userLocaleMiddleware = (options, next) => {
        ...
        if (
          ...
          options.path = Object(external_wp_url_["addQueryArgs"])(
            options.path,
            {
              _locale: "user",
            }
