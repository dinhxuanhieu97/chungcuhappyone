  ...
  /******/ {
    ...
    /***/ dsJ0: /***/ function (
      ...
      async function defaultProcessor(requests) {
        ...
        for (const batchRequests of Object(external_lodash_["chunk"])(
          requests,
          maxItems
        )) {
      ...
      function createBatch() {
        ...
        return {
          ...
          async run() {
            ...
            for (const [result, { resolve, reject }] of Object(
              external_lodash_["zip"]
            )(results, queue)) {
      ...
      function receiveEntityRecords(kind, name, records, query) {
        ...
        // on the server.
        if (kind === "postType") {
          records = Object(external_lodash_["castArray"])(records).map(
            (record) =>
        ...
        for (let i = 0; i < keys.length; i++) {
          ...
          switch (key) {
            ...
            default:
              ...
              if (key === "include") {
                parts.include =
                  get_normalized_comma_separable(value).map(Number); // Normalize value for `stableKey`.
      ...
      /* harmony default export */ var get_query_parts =
        with_weak_map_cache(getQueryParts);
            ...
            return Object(external_lodash_["mapValues"])(
              ...
              (contextQueries) => {
                return Object(external_lodash_["mapValues"])(
                  contextQueries,
                  (queryItems) => {
                    return Object(external_lodash_["filter"])(
                      queryItems,
                      (queryId) => {
      ...
      const reducer_entities = function () {
        ...
        if (!entitiesDataReducer || newConfig !== state.config) {
          const entitiesByKind = Object(external_lodash_["groupBy"])(
            newConfig,
            "kind"
          );
      ...
      const getQueriedItems = Object(rememo["a" /* default */])(function (
        state
      ) {
        let query =
          arguments.length > 1 && arguments[1] !== undefined
      ...
      const isRequestingEmbedPreview = Object(
      ...
      const selectors_getEntityRecord = Object(rememo["a" /* default */])(
        (state, kind, name, key, query) => {
          ...
          const queriedState = Object(external_lodash_["get"])(
            state.entities.data,
          ...
          if (query === undefined) {
            ...
            if (
              !(
                (_queriedState$itemIsC =
                  queriedState.itemIsComplete[context]) !== null &&
      ...
      const __experimentalGetDirtyEntityRecords = Object(
        rememo["a" /* default */]
      )(
        (state) => {
          const {
      ...
      const __experimentalGetEntitiesBeingSaved = Object(
        rememo["a" /* default */]
      )(
        (state) => {
          const {
      ...
      const getEntityRecordNonTransientEdits = Object(
        rememo["a" /* default */]
      )(
      ...
      function canUser(state, action, resource, id) {
        const key = Object(external_lodash_["compact"])([
          action,
          resource,
          id,
        ]).join("/");
      ...
      const hasFetchedAutosaves = Object(
        external_wp_data_["createRegistrySelector"]
      ...
      function __experimentalGetTemplateForLink(state, link) {
        ...
        const template =
          records !== null && records !== void 0 && records.length
            ? records[0]
            : null;
      ...
      const resolvers_getEditedEntityRecord =
        forward_resolver("getEntityRecord");
      /**
      ...
      const resolvers_canUser = (action, resource, id) => async (_ref7) => {
        ...
        const isAllowed = Object(external_lodash_["includes"])(
          allowHeader,
          method
        );
      ...
      const resolvers_experimentalGetCurrentGlobalStylesId =
        () => async (_ref13) => {
          ...
          const globalStylesURL = Object(external_lodash_["get"])(
            activeThemes,
      ...
      function useEntityBlockEditor(kind, type) {
        ...
        return [
          blocks !== null && blocks !== void 0
            ? blocks
            : entity_provider_EMPTY_ARRAY,
          onInput,
          onChange,
        ];
      }
      ...
      const entityResolvers = defaultEntities.reduce((result, entity) => {
        ...
        result[pluralMethodName].shouldInvalidate = function (action) {
          ...
          return resolvers_getEntityRecords.shouldInvalidate(
            action,
            kind,
            name,
            ...args
