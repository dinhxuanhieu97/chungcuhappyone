  ...
  /******/ {
    /***/ "0ATp": /***/ function (
      ...
      const getBlockSupport = (state, nameOrType, feature, defaultSupports) => {
        ...
        if (
          !(blockType !== null && blockType !== void 0 && blockType.supports)
        ) {
      ...
      function registration_getBlockType(name) {
        ...
        return (_select = Object(external_wp_data_["select"])(store)) ===
          null || _select === void 0
          ? void 0
      ...
      function normalizeIconObject(icon) {
        ...
        if (Object(external_lodash_["has"])(icon, ["background"])) {
          const colordBgColor = Object(colord["a" /* colord */])(
            icon.background
          );
          return {
            ...icon,
      ...
      function fixCustomClassname(blockAttributes, blockType, innerHTML) {
        if (registration_hasBlockSupport(blockType, "customClassName", true)) {
          ...
          const attributesSansClassName = Object(external_lodash_["omit"])(
            blockAttributes,
            ["className"]
          );
      ...
      function normalizeRawBlock(rawBlock) {
        ...
        if (rawBlockName === fallbackBlockName) {
          rawInnerHTML = Object(external_wp_autop_["autop"])(
            rawInnerHTML
          ).trim();
        }
      ...
      function parser_parse(content) {
        return Object(external_wp_blockSerializationDefaultParser_["parse"])(
          content
      ...
      function synchronizeBlocksWithTemplate() {
        ...
        return Object(external_lodash_["map"])(template, (_ref2, index) => {
          ...
          const isHTMLAttribute = (attributeDefinition) =>
            Object(external_lodash_["get"])(attributeDefinition, ["source"]) ===
            "html";
