...
this["wp"]["formatLibrary"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ t1DA: /***/ function (
      ...
      function getFormatBoundary(value, format) {
        ...
        const formatAtStart = Object(external_lodash_["find"])(
          newFormats[startIndex],
          {
            type: format.type,
          }
        );
        const formatAtEnd = Object(external_lodash_["find"])(
          newFormats[endIndex],
          {
            type: format.type,
          }
      ...
      const walkToEnd = Object(external_lodash_["partialRight"])(
        walkToBoundary,
        "forwards"
      );
      ...
      /* harmony default export */ var use_link_instance_key =
        useLinkInstanceKey;
      ...
      function InlineLinkUI(_ref) {
        ...
        const { createPageEntity, userCanCreatePages } = Object(
        ...
        function removeLink() {
          const newValue = Object(external_wp_richText_["removeFormat"])(
            value,
            "core/link"
          );
          onChange(newValue);
      ...
      function getRichTextValueFromSelection(value, isActive) {
        ...
        return Object(external_wp_richText_["slice"])(
          value,
          textStart,
          textEnd
        );
      ...
      function link_Edit(_ref) {
        ...
        function addLink() {
          ...
          if (
            text &&
            Object(external_wp_url_["isURL"])(text) &&
            isValidHref(text)
          ) {
            onChange(
      ...
      function setColors(value, name, colorSettings, colors) {
        ...
        if (color) {
          ...
          if (colorObject) {
            classNames.push(
              Object(external_wp_blockEditor_["getColorClassName"])(
                "color",
                colorObject.slug
              )
            );
   ...
   */
      ...
      default_formats.forEach((_ref) => {
        ...
        return Object(external_wp_richText_["registerFormatType"])(
          name,
          settings
        );
      });
