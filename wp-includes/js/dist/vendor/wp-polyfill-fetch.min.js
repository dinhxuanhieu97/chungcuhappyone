!(function (t, e) {
  ...
  var e,
    ...
    h =
      ...
      (void 0 !== h && h),
    o = "URLSearchParams" in h,
    n = "Symbol" in h && "iterator" in Symbol,
    u =
      "FileReader" in h &&
      "Blob" in h &&
      (function () {
        ...
        (this.bodyUsed = this.bodyUsed),
          (this._bodyInit = t)
            ? "string" == typeof t
              ...
              : f && u && (e = t) && DataView.prototype.isPrototypeOf(e)
              ? ((this._bodyArrayBuffer = b(t.buffer)),
                (this._bodyInit = new Blob([this._bodyArrayBuffer])))
              : f && (ArrayBuffer.prototype.isPrototypeOf(t) || r(t))
  ...
  function v(o, s) {
    return new Promise(function (n, t) {
      ...
      (i.onload = function () {
        ...
        !s || "object" != typeof s.headers || s.headers instanceof d
          ? e.headers.forEach(function (t, e) {
              i.setRequestHeader(e, t);
            })
          : Object.getOwnPropertyNames(s.headers).forEach(function (t) {
              i.setRequestHeader(t, c(s.headers[t]));
            }),
        e.signal &&
  ...
  (v.polyfill = !0),
    h.fetch ||
      ((h.fetch = v), (h.Headers = d), (h.Request = E), (h.Response = A)),
    (a.Headers = d),
    (a.Request = E),
    (a.Response = A),
    (a.fetch = v),
