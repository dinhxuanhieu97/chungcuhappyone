...
this["wp"]["keyboardShortcuts"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ cFS5: /***/ function (
      ...
      const selectors_getAllShortcutKeyCombinations = Object(
        rememo["a" /* default */]
      )(
        (state, name) => {
      ...
      const getAllShortcutRawKeyCombinations = Object(
        rememo["a" /* default */]
      )(
        (state, name) => {
          return selectors_getAllShortcutKeyCombinations(state, name).map(
      ...
      function useShortcutEventMatch() {
        const { getAllShortcutKeyCombinations } = Object(
        ...
        function isMatch(name, event) {
          return getAllShortcutKeyCombinations(name).some((_ref) => {
            ...
            return external_wp_keycodes_["isKeyboardEvent"][modifier](
              event,
              character
            );
          });
      ...
      function ShortcutProvider(props) {
        const keyboardShortcuts = Object(external_wp_element_["useRef"])(
          new Set()
        );
