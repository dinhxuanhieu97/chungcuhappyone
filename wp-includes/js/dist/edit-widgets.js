...
this["wp"]["editWidgets"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ F35A: /***/ function (
      ...
      const actions_moveBlockToWidgetArea =
      ...
      function WidgetAreaInnerBlocks(_ref) {
        ...
        const innerBlocksProps = Object(
          external_wp_blockEditor_["useInnerBlocksProps"]
        )(
          {
            ref: innerBlocksRef,
          },
      ...
      function WidgetAreasBlockEditorProvider(_ref) {
        ...
        const {
          ...
          (select) => ({
            ...
            ).isFeatureActive("core/edit-widgets", "fixedToolbar"),
            keepCaretInsideBlock: select(
              build_module["i" /* store */]
            ).isFeatureActive("core/edit-widgets", "keepCaretInsideBlock"),
          }),
          []
        );
      ...
      function Header() {
        ...
        const { isInserterOpen, isListViewOpen } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
        ...
        return Object(external_wp_data_["useSelect"])(
          (select) => {
            ...
            const insertionPoint =
              select(store).__experimentalGetInsertionPoint(); // "Browse all" in the quick inserter will set the rootClientId to the current block.
