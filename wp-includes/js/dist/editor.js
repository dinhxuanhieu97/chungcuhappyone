...
*/
    ...
    /***/ PLxR: /***/ function (
          ...
          Promise.all(pendingSavedRecords)
            .then((values) => {
              if (values.some((value) => typeof value === "undefined")) {
                createErrorNotice(
                  Object(external_wp_i18n_["__"])("Saving failed.")
                );
              } else {
                createSuccessNotice(
                  Object(external_wp_i18n_["__"])("Site updated."),
                  {
                    type: "snackbar",
                  }
                );
        ...
        const { localAutosaveInterval } = Object(
          ...
          (select) => ({
            localAutosaveInterval:
              select(store).getEditorSettings()
      ...
      const PageAttributesOrder = (_ref) => {
        ...
        const [orderInput, setOrderInput] = Object(
          external_wp_element_["useState"]
        )(null);
        ...
        const { postAuthor, authors } = Object(external_wp_data_["useSelect"])(
          (select) => {
            return {
              ...
              authors: select(external_wp_coreData_["store"]).getUsers(
                AUTHORS_QUERY
              ),
            };
          },
      ...
      function PostAuthor() {
        const showCombobox = Object(external_wp_data_["useSelect"])(
          (select) => {
            const authors = select(external_wp_coreData_["store"]).getUsers(
              AUTHORS_QUERY
            );
            return (
      ...
      function PostAuthorCheck(_ref) {
        let { children } = _ref;
        const { hasAssignAuthorAction, hasAuthors } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
      ...
      /* harmony default export */ var post_comments = Object(
        ...
        Object(external_wp_data_["withSelect"])((select) => {
          return {
            commentStatus:
              select(store).getEditedPostAttribute("comment_status"),
          };
        }),
        Object(external_wp_data_["withDispatch"])((dispatch) => ({
	...
	`;
      ...
      function FlatTermSelector(_ref) {
        ...
        const debouncedSearch = Object(external_wp_compose_["useDebounce"])(
          setSearch,
          500
        );
        const {
      ...
      /* harmony default export */ var maybe_tags_panel = Object(
        ...
        Object(external_wp_data_["withSelect"])((select) => {
          ...
          const tags =
            tagsTaxonomy &&
            select(store).getEditedPostAttribute(tagsTaxonomy.rest_base);
          return {
      ...
      class postpublish_PostPublishPanelPostpublish extends external_wp_element_[
        ...
        render() {
          ...
          const addLink = Object(external_wp_url_["addQueryArgs"])(
            "post-new.php",
            {
              post_type: post.type,
            }
            ...
            className:
              isSaveable || isSaving
                ? classnames_default()({
                    ...
                    "is-saved": isSaved,
                    [Object(
                      external_wp_components_["__unstableGetAnimateClassName"]
                    )({
                      type: "loading",
                    })]: isSaving,
                  })
      ...
      function HierarchicalTermSelector(_ref) {
        let { slug } = _ref;
        const [adding, setAdding] = Object(external_wp_element_["useState"])(
          false
        );
        const [formName, setFormName] = Object(
          external_wp_element_["useState"]
        )("");
        /**
        ...
        const [formParent, setFormParent] = Object(
          external_wp_element_["useState"]
        )("");
        const [showForm, setShowForm] = Object(
          external_wp_element_["useState"]
        )(false);
        const [filterValue, setFilterValue] = Object(
          external_wp_element_["useState"]
        )("");
      ...
      function PostTitle() {
        ...
        const [selection, setSelection] = Object(
          external_wp_element_["useState"]
        )({});
        ...
        const { ref: richTextRef } = Object(
          external_wp_richText_["__unstableUseRichText"]
        )({
          value: title,
          onChange,
      ...
      function EditorProvider(_ref) {
        ...
        const { createWarningNotice } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_notices_["store"]); // Initialize and tear down the editor.
