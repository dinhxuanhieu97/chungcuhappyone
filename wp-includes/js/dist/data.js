...
this["wp"]["data"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ pfJ3: /***/ function (
            ...
            (_ref = {
              ...
              subscribe: function subscribe(observer) {
                if (typeof observer !== "object" || observer === null) {
                  throw new Error(
                    true ? formatProdErrorMessage(11) : undefined
                  );
                }
      ...
      var external_wp_reduxRoutine_default =
        /*#__PURE__*/ __webpack_require__.n(external_wp_reduxRoutine_);
      ...
      function instantiateReduxStore(key, options, registry, thunkArgs) {
        ...
        const normalizedControls = Object(external_lodash_["mapValues"])(
          controls,
      ...
      function mapResolvers(resolvers, selectors, store, resolversCache) {
        ...
        const mappedResolvers = Object(external_lodash_["mapValues"])(
          resolvers,
          (resolver) => {
            if (resolver.fulfill) {
              return resolver;
      ...
      async function fulfillResolver(store, resolvers, selectorName) {
        const resolver = Object(external_lodash_["get"])(resolvers, [
          selectorName,
        ]);
      ...
      function createRegistry() {
        ...
        function select(storeNameOrDefinition) {
          const storeName = Object(external_lodash_["isObject"])(
            storeNameOrDefinition
          )
            ? storeNameOrDefinition.name
            : storeNameOrDefinition;
        ...
        function registerGenericStore(key, config) {
          ...
          config.subscribe = (listener) => {
            const unsubscribeFromStoreEmitter =
              config.emitter.subscribe(listener);
        ...
        function batch(callback) {
          emitter.pause();
          Object(external_lodash_["forEach"])(stores, (store) =>
            store.emitter.pause()
          );
          callback();
          emitter.resume();
      ...
      const context_Context = Object(external_wp_element_["createContext"])(
        false
      );
      ...
      function useSelect(_mapSelect, deps) {
        ...
        const mapSelect = Object(external_wp_element_["useCallback"])(
          _mapSelect,
          deps
        );
        const registry = useRegistry();
        ...
        const isMountedAndNotUnsubscribing = Object(
          external_wp_element_["useRef"]
        ...
        Object(external_wp_compose_["useIsomorphicLayoutEffect"])(() => {
          ...
          return () => {
            ...
            unsubscribers.forEach((unsubscribe) =>
              unsubscribe === null || unsubscribe === void 0
                ? void 0
                : unsubscribe()
            );
            renderQueue.flush(queueContext);
      ...
      const useDispatchWithMap = (dispatchMap, deps) => {
        const registry = useRegistry();
        const currentDispatchMap = Object(external_wp_element_["useRef"])(
          dispatchMap
        );
        Object(external_wp_compose_["useIsomorphicLayoutEffect"])(() => {
      ...
      /* harmony default export */ var use_dispatch_with_map =
        useDispatchWithMap;
      ...
      const build_module_registerGenericStore =
