    ...
    /***/ yyEc: /***/ function (
      ...
      function applyFormat(value, format) {
        ...
        if (startIndex === endIndex) {
          const startFormat = Object(external_lodash_["find"])(
      ...
      function toFormat(_ref) {
        ...
        if (attributes && attributes.class) {
          formatType = Object(external_wp_data_["select"])(
            store
      ...
      function registerFormatType(name, settings) {
        ...
        if (
          Object(external_wp_data_["select"])(store).getFormatType(
            settings.name
          )
        ) {
          window.console.error(
      ...
      function removeFormat(value, formatType) {
        ...
        if (startIndex === endIndex) {
          const format = Object(external_lodash_["find"])(
            newFormats[startIndex],
            {
              type: formatType,
            }
      ...
      function insertLineSeparator(value) {
        ...
        const previousLineSeparatorIndex =
          beforeText.lastIndexOf(LINE_SEPARATOR);
      ...
      function createElementHTML(_ref6) {
        ...
        for (const key in attributes) {
          ...
          attributeString += ` ${key}="${Object(
            external_wp_escapeHtml_["escapeAttribute"]
          )(attributes[key])}"`;
        }
        ...
        return children
          .map((child) => {
            ...
            return child.text === undefined
              ...
              : Object(external_wp_escapeHtml_["escapeEditableHTML"])(
                  child.text
                );
          })
          .join("");
      ...
      function unregisterFormatType(name) {
        const oldFormat = Object(external_wp_data_["select"])(
          store
        ).getFormatType(name);
      ...
      function canIndentListItems(value) {
        ...
        const formatsAtPreviousLineIndex =
          replacements[previousLineIndex] || []; // If the indentation of the current line is greater than previous line,
      ...
      function useRichText(_ref) {
        ...
        const hadSelectionUpdate = Object(external_wp_element_["useRef"])(
          false
        );
