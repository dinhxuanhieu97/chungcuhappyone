...
!(function (i) {
  ...
  Ffsb: function (t, e) {
    var i = wp.media.view.Button,
      ...
      n = i.extend({
        ...
        click: function () {
          i.prototype.click.apply(this, arguments),
  ...
  LRQ5: function (t, e, i) {
    var o = wp.media;
    (o.controller.EditAttachmentMetadata = i("ZJBI")),
      (o.view.MediaFrame.Manage = i("lH8y")),
      (o.view.Attachment.Details.TwoColumn = i("FcM5")),
      (o.view.MediaFrame.Manage.Router = i("OMfl")),
      (o.view.EditImage.Details = i("HUrf")),
      (o.view.MediaFrame.EditAttachments = i("wQX5")),
      (o.view.SelectModeToggleButton = i("Ffsb")),
      (o.view.DeleteSelectedButton = i("nD7t")),
      (o.view.DeleteSelectedPermanentlyButton = i("1lLZ"));
  },
  OMfl: function (t, e) {
      ...
      s = i.extend({
        initialize: function () {
          _.defaults(this.options, {
            ...
            (this.$adminBar = n("#wpadminbar")),
            (this.$uploaderToggler = n(".page-title-action")
            ...
            this.options.uploader &&
              ...
              this.uploader.ready(),
              n("body").append(this.uploader.el),
              (this.options.uploader = !1)),
            ...
            o = _.throttle(function (t) {
              ...
              e &&
                this.gridRouter.navigate(
                  this.gridRouter.baseUrl((t += "?search=" + e)),
                  { replace: !0 }
                );
            }, 1e3);
  ...
  nD7t: function (t, e) {
    var i = wp.media.view.Button,
      ...
      n = i.extend({
        ...
        filterChange: function (t) {
          "trash" === t.get("status")
            ? this.model.set("text", o.restoreSelected)
            : wp.media.view.settings.mediaTrash
            ? this.model.set("text", o.trashSelected)
            : this.model.set("text", o.deletePermanently);
        },
      ...
      o = o.extend({
        ...
        createModal: function () {
          this.options.modal &&
            ...
            this.modal.on(
              "close",
              _.bind(function () {
                n("body").off("keydown.media-modal"),
                  n(
        ...
        keyEvent: function (t) {
          (("INPUT" !== t.target.nodeName &&
            ...
            t.target.readOnly ||
            t.target.disabled) &&
            (39 === t.keyCode && this.nextMediaItem(),
            37 === t.keyCode && this.previousMediaItem());
        },
        resetRoute: function () {
